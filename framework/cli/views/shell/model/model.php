...
*/ class
<?php echo $className; ?>
extends CActiveRecord { /** * @return string the associated database
...
public function search() { // Warning: Please modify the following code
to remove attributes that // should not be searched. $criteria=new
CDbCriteria;
...
<?php echo $className; ?>
', array( 'criteria'=>$criteria, )); } /** * Returns the static model of
the specified AR class. * @return
<?php echo $className; ?>
