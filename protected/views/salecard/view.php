...
<div class="row-fluid">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/Salecard/Updatesale">
                <fieldset>
                    <input type="hidden" name="k_id" value="<?php echo $saledata->keywords_id; ?>">
                    <input type="hidden" name="id" value="<?php echo $saledata->id; ?>">
                    <div class="control-group">
                        <label class="control-label" >活动名称</label>
                        <div class="controls">
                            <input type="text" name="name" value="<?php echo $saledata->name; ?>" id="name">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="keywords" value="<?php echo $saledata->keywords; ?>" id="keywords">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="index_title" value="<?php echo $saledata->index_title; ?>" id="index_title">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div id="showimg" class="showimg" style="margin-left:160px;width:320px;margin-top: 10px;">
                                <img src="<?php echo Yii::app()->request->baseUrl; ?>/upload/slider/<?php echo $saledata->index_image; ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" >活动简短描述</label>
                        <div class="controls">
                            <textarea name="description" style="height:120px;width: 320px" id="description"><?php echo $saledata->description; ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="date01">活动时间</label>
                        <div class="controls">
                            <input type="text" name="start_date" style="width:120px;"  data-date-format="dd-mm-yyyy" class="input-xlarge datepicker" id="date01" value="<?php echo $saledata->start_date; ?>"> ~
                            <input type="text" name="end_date" style="width:120px;"  data-date-format="dd-mm-yyyy" class="input-xlarge datepicker" id="date02" value="<?php echo $saledata->end_date; ?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input id="appendedInput" size="16" type="text" name="chance" value="<?php echo $saledata->chance; ?>" class="chance"><span class="add-on">%</span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input id="appendedInput" size="16" type="text" name="user_everyday_times" value="<?php echo $saledata->user_everyday_times; ?>" class="user_everyday_times"><span class="add-on">次</span>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="hidden" name="index_image" id="index_image" value="<?php echo $saledata->index_image; ?>">
                        </div>
