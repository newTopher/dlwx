...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="keywords" class="notallow1" value="<?php echo $key->keywords;?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="inputSuccess" name="title" class="notallow2" value="<?php echo $order->title;?>">
    </div>
</div>
<div class="control-group">
    ...
    <div id="showimg" class="showimg" style="margin-left:160px;width:320px;margin-top: 10px;height:180px;">
       <img style="height:180px; width:320px;" src="<?php echo Yii::app()->request->baseUrl.'/upload/slider/'.$order->image_path ;?>">
    </div>
</div>
<div class="control-group">
    <label class="control-label" >简短介绍</label>
    <div class="controls">
        <textarea  style="height:120px;width: 320px" name="introduce" class="notallow4" ><?php echo $order->introduce;?></textarea>
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div id="showimg1" class="showimg" style="margin-left:160px;width:320px;margin-top: 10px;">
        <img style="height:180px; width:320px;" src="<?php echo Yii::app()->request->baseUrl.'/upload/slider/'.$order->header_image_path; ;?>">
    </div>
</div>
<div class="control-group">
    <label class="control-label" >预约电话</label>
    <div class="controls">
        <textarea name="order_tel" style="height:120px;width: 320px" class="notallow8"><?php $ordertel=json_decode($order->order_tel) ;foreach($ordertel as $val){echo $val ;'<br>';}?></textarea>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="setname_tel" value="<?php echo $order->setname_tel;?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <textarea name="description" style="height:120px;width: 320px" class="notallow9"><?php echo $order->order_introduce;?></textarea>
        <span class="help-inline">每行填写一个</span>
    </div>
</div>
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="setname_desc" value="<?php echo $order->setname_introduce;?>">
