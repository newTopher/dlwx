...
<div class="row-fluid">
    <div class="box span12">
        <div class="box-header well">
            <h2><a href="<?php echo Yii::app()->request->baseUrl; ?>/CallingcardManage/Index"><i class="icon-info-sign"></i> 预约管理 </a></h2>
                        ...
                        <div class="box span4" style="margin-left:1%;margin-top:10px;width:31.5%">
                            ...
                            <div class="box-content buttons" style="min-height: 150px;">
                                <div id="realtimechart" style="height: 180px; padding: 0px; position: relative;">
                                    <?php if($v->image_path):?>
                                        <a href="<?php echo Yii::app()->request->baseUrl.'/OrderManage/OrderList/uid/'.$v->uid.'/oid/'.$v->id;?>">
                                            <img src="<?php echo Yii::app()->baseUrl.'/upload/slider/'.$v->image_path;?>" width="320" height="180">
                                        </a>
                                    <?php else:?>
                                        <a style="text-decoration: none;" href="<?php echo Yii::app()->request->baseUrl.'/OrderManage/OrderList/uid/'.$v->uid.'/oid/'.$v->id;?>"><div style=" height:180px;width:308px;background: #ececec;font-size:20px;text-align: center ;color: #c0c0c0;text-align: center;line-height: 160px;font-weight: 400;">无封面图</div></a>
                                    <?php endif;?>
                                </div>
                            </div>
                        </div><!--/span-->
