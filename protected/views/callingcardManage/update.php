...
<form class="form-horizontal" action="<?php echo Yii::app()->request->baseUrl.'/CallingcardManage/Update/id/'.$card->id.'/kid/'.$key->id;?>" method="post">
    <fieldset>
        <div class="control-group">
            <label class="control-label">触发关键词</label>
            <div class="controls">
                <input type="text" name="keywords" class="notallow1" value="<?php echo $card->keywords;?>">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="inputSuccess" name="title" class="notallow2" value="<?php echo $card->title;?>">
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="btn btn-info" style="margin-left: 20px; width: 80px;height: 18px;">选择图片
                ...
                <input id="image_path_input" type="hidden" name="image_path" value="<?php echo $card->image_path;?>" class="notallow3">
            </div>
            ...
            <div id="showimg" class="showimg" style="margin-left:160px;width:320px;margin-top: 10px;">
                <img style="height:180px; width:320px;" src="<?php echo Yii::app()->request->baseUrl.'/upload/slider/'.$card->image_path;?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" >简短介绍</label>
            <div class="controls">
                <textarea  style="height:120px;width: 320px" name="introduce" class="notallow4"><?php echo $card->introduce;?></textarea>
        ...
        <div class="control-group">
            ...
            <div class="btn btn-info" style="margin-left: 20px; width: 80px;height: 18px;">选择头像
                ...
                <input id="image_path_input1" type="hidden" name="head_image_path" value="<?php echo $card->head_image_path;?>" class="notallow7">
            </div>
            ...
            <div id="showimg1" class="showimg" style="margin-left:160px;margin-top: 10px;">
                <img style="height:320px; width:320px;" src="<?php echo Yii::app()->request->baseUrl.'/upload/slider/'.$card->head_image_path;?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" >姓名</label>
            <div class="controls">
                <input type="text" name="username"  value="<?php echo $card->name;?>">
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="job"  value="<?php echo $card->job;?>">
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="company"  value="<?php echo $card->company;?>">
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="mobilephone"  value="<?php echo $card->mobilephone;?>">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="tel1"  value="<?php echo $card->tel1;?>" >
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="tel2"  value="<?php echo $card->tel2;?>">
        ...
        <div class="control-group">
            ...
            <div class="btn btn-info" style="margin-left: 20px; width: 80px;height: 18px;">选择二维码
                ...
                <input id="image_path_input2" type="hidden" name="qrcode" value="<?php echo $card->qrcode;?>" class="notallow7">
            </div>
            ...
            <div id="showimg2" class="showimg" style="margin-left:180px;margin-top: 10px;">
                <img style="height:250px; width:250px;" src="<?php echo Yii::app()->request->baseUrl.'/upload/slider/'.$card->qrcode;?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" >邮箱</label>
            <div class="controls">
                <input type="text" name="email"  value="<?php echo $card->email;?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" >Q Q</label>
            <div class="controls">
                <input type="text" name="qq"  value="<?php echo $card->qq;?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" >网址</label>
            <div class="controls">
                <input type="text" name="website" value="<?php echo $card->website;?>" >
        ...
        <div class="control-group">
            ...
            <div class="btn btn-info" style="margin-left: 20px; width: 80px;height: 18px;">选择名片背景
                ...
                <input id="image_path_input3" type="hidden" name="background_path" value="<?php echo $card->background_path;?>" class="notallow7">
            </div>
            ...
            <div id="showimg3" class="showimg" style="margin-left:160px;width:320px;margin-top: 10px;">
                <img style="height:640px; width:320px;" src="<?php echo Yii::app()->request->baseUrl.'/upload/slider/'.$card->background_path;?>">
            </div>
        </div>
        <div class="control-group">
