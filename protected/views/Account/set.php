                ...
                <form class="form-horizontal">
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <span class="input-xlarge uneditable-input">qiaojianlan@wapwei.com</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">公司名称</label>
                            <div class="controls">
                                <span class="input-xlarge uneditable-input">北京俏江兰食品股份有限公司</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">微信公众号</label>
                            <div class="controls">
                                <span class="input-xlarge uneditable-input">qiao2014</span>
                            </div>
                        </div>
                        <div class="control-group">
