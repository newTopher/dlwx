...
<div class="row-fluid">
    <div class="box span12">
        ...
        <div class="box-content">
            <div class="box-content">
                <a class="btn btn-primary" style="margin-bottom: 10px;" href="<?php echo Yii::app()->request->baseUrl; ?>/Zhuancard/Addzhuan">创建幸运大转盘活动</a>
                <div class="alert alert-info">
                    <button type="button" class="close" data-dismiss="alert">×</button>
                    <strong>提示信息!</strong>  您可以定期创建一些幸运大转盘活动,来吸引您的活跃你的粉丝.
                </div>


                <ul class="thumbnails">
                    <?php if($zhuanlist != null): ?>
                        <?php foreach($zhuanlist as $k=>$v): ?>
                        <li class="span3">
                            <div class="thumbnails">
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/Zhuancard/Getprizeuser/id/<?php echo $v->id;?>">
                                ...
                                <div class="caption">
                                    <h3><?php echo $v->index_title; ?>
                                        <span style="font-size: 10px;padding-left: 10px;color: green;">
                                            ...
                                            进行中 (<?php echo ActivityRecordModel::getCountsUserByAid($v->id,3); ?>人参加)
                                            <?php endif; ?>
                                        </span>
                                    </h3>
                                    <p style="margin-top: 20px;"><a href="<?php echo Yii::app()->request->baseUrl; ?>/Zhuancard/Viewzhuan/id/<?php echo $v->id; ?>/kid/<?php echo $v->keywords_id; ?>" class="btn btn-primary">修改活动</a></p>
                                </div>
                            </div>
                        </li>
                        <?php endforeach; ?>
