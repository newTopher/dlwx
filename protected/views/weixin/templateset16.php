                ...
                <div class="span8" style="width: 560px;height: 800px;">
                    <div class="m_lefter" template='<?php echo $template_id; ?>' site='<?php echo $site_id; ?>'>
                        <div id="web_skin_index">
                            <div class="web_skin_index_list banner"  id="slider" el="edit-t01" no="0">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p1_box" p1_nav_link="<?php if(isset(CJSON::decode($templateData->p1,false)->linkid)){ echo CJSON::decode($templateData->p1,false)->linkid; }else { echo '0'; } ?>"
                                                ...
                                                <div class="img"><img id="p1_image" src="<?php if(isset(CJSON::decode($templateData->p1,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p1,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i0.jpg'; } ?>"></div>
                                                <div class="text"><a id="p1_atext" href=""><?php if(isset(CJSON::decode($templateData->p1,false)->title)){ echo CJSON::decode($templateData->p1,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p2_box" p2_nav_link="<?php if(isset(CJSON::decode($templateData->p2,false)->linkid)){ echo CJSON::decode($templateData->p2,false)->linkid; }else { echo '0'; } ?>"
                                                ...
                                                <div class="img"><img id="p2_image" src="<?php if(isset(CJSON::decode($templateData->p2,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p2,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i4.jpg'; } ?>"></div>
                                                <div class="text"><a id="p12_atext" href=""><?php if(isset(CJSON::decode($templateData->p2,false)->title)){ echo CJSON::decode($templateData->p2,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>
                                        ...
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p3_box" p3_nav_link="<?php if(isset(CJSON::decode($templateData->p3,false)->linkid)){ echo CJSON::decode($templateData->p3,false)->linkid; }else { echo '0'; } ?>"
                                                ...
                                                <div class="img"><img id="p3_image" src="<?php if(isset(CJSON::decode($templateData->p3,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p3,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i2.jpg'; } ?>"></div>
                                                <div class="text"><a id="p3_atext" href=""><?php if(isset(CJSON::decode($templateData->p3,false)->title)){ echo CJSON::decode($templateData->p3,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod">&nbsp;</div>
                                        ...
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p4_box" p4_nav_link="<?php if(isset(CJSON::decode($templateData->p4,false)->linkid)){ echo CJSON::decode($templateData->p4,false)->linkid; }else { echo '0'; } ?>"
                                                ...
                                                <div class="img"><img id="p4_image" src="<?php if(isset(CJSON::decode($templateData->p4,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p4,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"></div>
                                                <div class="text"><a id="p4_atext" href=""><?php if(isset(CJSON::decode($templateData->p4,false)->title)){ echo CJSON::decode($templateData->p4,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>
                                        ...
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p5_box" p5_nav_link="<?php if(isset(CJSON::decode($templateData->p5,false)->linkid)){ echo CJSON::decode($templateData->p5,false)->linkid; }else { echo '0'; } ?>"
                                                ...
                                                <div class="img"><img id="p5_image" src="<?php if(isset(CJSON::decode($templateData->p5,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p5,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"></div>
                                                <div class="text"><a id="p5_atext" href=""><?php if(isset(CJSON::decode($templateData->p5,false)->title)){ echo CJSON::decode($templateData->p5,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>
                                        ...
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p6_box" p6_nav_link="<?php if(isset(CJSON::decode($templateData->p6,false)->linkid)){ echo CJSON::decode($templateData->p6,false)->linkid; }else { echo '0'; } ?>"
                                                ...
                                                <div class="img"><img id="p6_image" src="<?php if(isset(CJSON::decode($templateData->p6,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p6,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"></div>
                                                <div class="text"><a id="p6_atext" href=""><?php if(isset(CJSON::decode($templateData->p6,false)->title)){ echo CJSON::decode($templateData->p6,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>

                                            </div>
                                        </li>
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p7_box" p7_nav_link="<?php if(isset(CJSON::decode($templateData->p7,false)->linkid)){ echo CJSON::decode($templateData->p7,false)->linkid; }else { echo '0'; } ?>"
                                                 p7_title="<?php if(isset(CJSON::decode($templateData->p7,false)->title)){ echo CJSON::decode($templateData->p7,false)->title; }else { echo '招聘培训'; } ?>" ref="p7"
                                                 p7_image="<?php if(isset(CJSON::decode($templateData->p7,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p7,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"
                                                 p7_image_name="<?php if(isset(CJSON::decode($templateData->p7,false)->pic)){ echo CJSON::decode($templateData->p7,false)->pic; }else{ echo ''; } ?>">
                                                <div class="img"><img id="p7_image" src="<?php if(isset(CJSON::decode($templateData->p7,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p7,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"></div>
                                                <div class="text"><a id="p7_atext" href=""><?php if(isset(CJSON::decode($templateData->p7,false)->title)){ echo CJSON::decode($templateData->p7,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>

                                            </div>
                                        </li>
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p8_box" p8_nav_link="<?php if(isset(CJSON::decode($templateData->p8,false)->linkid)){ echo CJSON::decode($templateData->p8,false)->linkid; }else { echo '0'; } ?>"
                                                 p8_title="<?php if(isset(CJSON::decode($templateData->p8,false)->title)){ echo CJSON::decode($templateData->p8,false)->title; }else { echo '招聘培训'; } ?>" ref="p8"
                                                 p8_image="<?php if(isset(CJSON::decode($templateData->p8,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p8,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"
                                                 p8_image_name="<?php if(isset(CJSON::decode($templateData->p8,false)->pic)){ echo CJSON::decode($templateData->p8,false)->pic; }else{ echo ''; } ?>">
                                                <div class="img"><img id="p8_image" src="<?php if(isset(CJSON::decode($templateData->p8,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p8,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"></div>

                                                <div class="text"><a id="p8_atext" href=""><?php if(isset(CJSON::decode($templateData->p8,false)->title)){ echo CJSON::decode($templateData->p8,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>

                                            </div>
                                        </li>
                                        <li>
                                            <div class="web_skin_index_list items mini_box" id="p9_box" p9_nav_link="<?php if(isset(CJSON::decode($templateData->p9,false)->linkid)){ echo CJSON::decode($templateData->p9,false)->linkid; }else { echo '0'; } ?>"
                                                 p9_title="<?php if(isset(CJSON::decode($templateData->p9,false)->title)){ echo CJSON::decode($templateData->p9,false)->title; }else { echo '招聘培训'; } ?>" ref="p9"
                                                 p9_image="<?php if(isset(CJSON::decode($templateData->p9,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p9,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"
                                                 p9_image_name="<?php if(isset(CJSON::decode($templateData->p9,false)->pic)){ echo CJSON::decode($templateData->p9,false)->pic; }else{ echo ''; } ?>">
                                                <div class="img"><img id="p9_image" src="<?php if(isset(CJSON::decode($templateData->p9,false)->pic)){ echo Yii::app()->request->baseUrl.'/upload/slider/'.CJSON::decode($templateData->p9,false)->pic; }else{ echo Yii::app()->request->baseUrl.'/backtheme/'.$template_name.'/image/i3.jpg'; } ?>"></div>
                                                <div class="text"><a id="p9_atext" href=""><?php if(isset(CJSON::decode($templateData->p8,false)->title)){ echo CJSON::decode($templateData->p8,false)->title; }else { echo '服务项目'; } ?></a></div>
                                                <div class="mod" style="display: none;">&nbsp;</div>
