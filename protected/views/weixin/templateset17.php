                ...
                <div class="span8" style="width: 560px;height: 800px;">
                    <div class="m_lefter" template='<?php echo $template_id; ?>' site='<?php echo $site_id; ?>'>
                        <div id="web_skin_index">
                            <div class="web_skin_index_list banner" id="slider" no="0">
...
<script type="text/javascript">
    ...
    $("#slider").mouseenter(function(){
        if($(this).find("#SetHomeCurrentBox").data('flag') != 1){
            $(this).append("<div id='SetHomeCurrentBox' style='height: 256px; width: 511px;line-height: 256px;'>" +
                "点击添加轮播图</div>");
        }
    }).mouseleave(function(){
            if($(this).find("#SetHomeCurrentBox").data('flag') != 1){
    ...
    $(".mini_box").each(function(i,e){
        $(this).mouseenter(function(){
            if($(this).find("#SetHomeCurrentBox").data('flag') != 1){
                $(this).append("<div id='SetHomeCurrentBox' style='height:86px; width: 86px;line-height: 86px;'>" +
                    "点击修改此模块</div>");
            }
        }).mouseleave(function(){
                if($(this).find("#SetHomeCurrentBox").data('flag') != 1){
