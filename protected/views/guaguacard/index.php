...
<div class="row-fluid">
    <div class="box span12">
        ...
        <div class="box-content">
            <div class="box-content">
                <a class="btn btn-primary" style="margin-bottom: 10px;" href="<?php echo Yii::app()->request->baseUrl; ?>/Guaguacard/Addguagua">创建刮刮卡活动</a>
                <div class="alert alert-info">
                    <button type="button" class="close" data-dismiss="alert">×</button>
                    <strong>提示信息!</strong>  您可以定期创建一些刮刮卡活动,来吸引您的活跃你的粉丝.
                </div>


                <ul class="thumbnails">
                    <?php if($guagualist != null): ?>
                        <?php foreach($guagualist as $k=>$v): ?>
                        <li class="span3">
                            <div class="thumbnails">
                                ...
                                <div class="caption">
                                    ...
                                    <p style="margin-top: 20px;"><a href="<?php echo Yii::app()->request->baseUrl; ?>/Guaguacard/Viewguagua/id/<?php echo $v->id; ?>/kid/<?php echo $v->keywords_id; ?>" class="btn btn-primary">修改活动</a></p>
                                </div>
                            </div>
                        </li>
                        <?php endforeach; ?>
