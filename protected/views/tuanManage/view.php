...
<div class="row-fluid">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/TuanManage/Updatetuan">
                <fieldset>
                    <input type="hidden" name="id" value="<?php echo $tuandata->id; ?>">
                    <div class="control-group">
                        <label class="control-label" >团购名称</label>
                        <div class="controls">
                            <input type="text" name="name" value="<?php echo $tuandata->name; ?>" id="name">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input id="appendedInput" size="16" type="text" name="price" value="<?php echo $tuandata->price; ?>" class="user_everyday_times"><span class="add-on">元</span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input id="appendedInput" size="16" type="text" name="o_price" value="<?php echo $tuandata->o_price; ?>" class="user_everyday_times"><span class="add-on">元</span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input id="appendedInput" size="16" type="text" name="sum" value="<?php echo $tuandata->sum; ?>" class="user_everyday_times"><span class="add-on">份</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input id="appendedInput" size="16" type="text" name="every_limit" value="<?php echo $tuandata->every_limit; ?>" class="user_everyday_times"><span class="add-on">份</span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input id="appendedInput" size="16" type="text" name="init_num" value="<?php echo $tuandata->init_num; ?>" class="user_everyday_times"><span class="add-on">人</span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="start_date" style="width:120px;"  data-date-format="dd-mm-yyyy" class="input-xlarge datepicker" id="date01" value="<?php echo $tuandata->start_date; ?>"> ~
                            <input type="text" name="end_date" style="width:120px;"  data-date-format="dd-mm-yyyy" class="input-xlarge datepicker" id="date02" value="<?php echo $tuandata->end_date; ?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="description" style="height:120px;width: 320px" id="description"><?php echo $tuandata->description; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="need_know" style="height:120px;width: 320px" id="description"><?php echo $tuandata->need_know; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="text_box">
                        ...
                        <div class="controls">
                            <textarea name="tuan_detail" id="text_content"><?php echo $tuandata->tuan_detail; ?></textarea>
                        </div>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="hidden" name="index_image" id="index_image" value="<?php echo $tuandata->index_image; ?>">
                        </div>
