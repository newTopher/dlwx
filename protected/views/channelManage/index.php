...
<div class="row-fluid">
    <div class="box span12">
        ...
        <div class="box-content">
            <div class="box-content">
                <a class="btn btn-primary" href="<?php echo Yii::app()->request->baseUrl; ?>/ChannelManage/AddChannelview">添加栏目</a>
                        ...
                        <?php foreach($channel_data as $k=>$v): ?>
                            <li class="ui-state-default">
                                <div class="title_head">一级栏目:&nbsp;&nbsp;&nbsp;<?php echo $v['one']['name']; ?><span class="tool_bar"><a href="<?php echo Yii::app()->request->baseUrl; ?>/ChannelManage/Channeledit/id/<?php echo $v['one']['id']; ?>" class="btn">修改</a>
                                        <a href="<?php echo Yii::app()->request->baseUrl; ?>/ChannelManage/AddChannelview/pid/<?php echo $v['one']['id']; ?>" class="btn">添加内容</a>
                                    ...
                                    <div class="sub_box">
                                        <ul class="sortablesub">
                                            <?php foreach($v['sub_data'] as $ks=>$vs): ?>
                                                <li><?php echo $vs->id; ?>: &nbsp;&nbsp;&nbsp;<?php echo $vs->name; ?><span class="tool_bar"><a href="<?php echo Yii::app()->request->baseUrl; ?>/ChannelManage/Channeledit/id/<?php echo $vs->id; ?>/pid/<?php echo $vs->pid; ?>" class="btn">修改</a>
