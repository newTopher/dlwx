...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script src="<?php echo Yii::app()->request->baseUrl; ?>/js/wapwei/saved_resource" charset="utf-8"></script><script src="<?php echo Yii::app()->request->baseUrl; ?>/js/wapwei/ujian.js" charset="utf-8" id="uyan_script"></script><script src="<?php echo Yii::app()->request->baseUrl; ?>/js/wapwei/style7.js" charset="utf-8" id="uyan_script"></script><script src="<?php echo Yii::app()->request->baseUrl; ?>/js/wapwei/saved_resource(1)" charset="utf-8" id="uyan_script"></script>
    ...
    <title><?php echo $sourcedata->title; ?></title>

    <meta content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport">
    <meta name="Keywords" content="<?php echo $sourcedata->title; ?>">
    <meta name="Description" content="<?php echo $sourcedata->description; ?>">
...
<div class="weimob-content">
    <h3><?php echo $sourcedata->title; ?></h3>
    <div class="pub_time"><?php echo date("Y.m.d",$sourcedata->add_time); ?></div>
    <div class="head_logo">
        <div>
...
<script type="text/javascript">
    document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
        window.shareData = {
            ...
            "timeLineLink": "http://weixin.wapwei.com/Cwapwei/I/id/<?php echo $sourcedata->id; ?>/sid/<?php echo $userdata->id; ?>/openid/<?php echo $openid;  ?>/from/<?php echo $openid;  ?>/type/timeline",
            "sendFriendLink": "http://weixin.wapwei.com/Cwapwei/I/id/<?php echo $sourcedata->id; ?>/sid/<?php echo $userdata->id; ?>/openid/<?php echo $openid;  ?>/from/<?php echo $openid;  ?>/type/friend",
            "weiboLink": "http://weixin.wapwei.com/Cwapwei/I/id/<?php echo $sourcedata->id; ?>/sid/<?php echo $userdata->id; ?>/openid/<?php echo $openid;  ?>/from/<?php echo $openid;  ?>/type/weibo",
            "tTitle": "<?php echo $sourcedata->title; ?> -- <?php echo $webdata->webname_title; ?>",
            "tContent": "<?php echo $sourcedata->title; ?>",
            "fTitle": "<?php echo $sourcedata->title; ?> -- <?php echo $webdata->webname_title; ?>",
            "fContent": "<?php echo $sourcedata->title; ?>",
            "wContent": "<?php echo $sourcedata->title; ?>"
        };
        // 发送给好友
