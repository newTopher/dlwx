 ...
 */
class ZhuanCardModel extends Ar{
    ...
    public function getZhuanlistByUid(){
    ...
    static public function getDataZhuanlistByUid($uid){
    ...
    static public function getZhuanCardByUid($uid,$keywords){
        return self::model()->findByAttributes(array('uid'=>$uid,'keywords'=>$keywords));
    }

    static public function getZhuanCardById($id){
