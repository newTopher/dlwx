...
<div id="web_page_contents_loading"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/resource/images/loading.gif"></div><div id="header" class="wrap" style="display: none;">
    ...
    <script language="javascript">
        var web_skin_data=[{"PId":"64520","SId":"16","TradeId":"0","MemberId":"2294","ContentsType":"1","Title":"[\"\"]","ImgPath":"[\"\\\/api\\\/web\\\/skin\\\/014\\\/images\\\/0\\\/banner.jpg\"]","Url":"[\"\\\/api\\\/a290abf710\\\/web\\\/\"]","Postion":"t01","Width":"640","Height":"1010","NeedLink":"0"}];
        var MusicPath='';
    ...
    <div id="web_skin_index">
        <div class="web_skin_index_list banner" rel="edit-t01">
            <div class="img" style="height: 606px;"><div class="slider" style="height: 606px;"><div class="flexslider" style="height: 606px;">
                        <ul class="slides" style="height: 606px;"><li style="display: list-item; height: 606px;">
                                <img src="<?php echo Yii::app()->theme->baseUrl; ?>/resource/images/banner.jpg" alt=""></li></ul></div></div></div>
        </div>
    </div>
</div><div id="support" style="bottom: 0px; display: none;"><a href="http://weixin.wapwei.com/wapwei/index.html" target="_self">本功能由蓝狮网络提供技术支持</a></div>
</body></html>