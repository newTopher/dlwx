...
function docReady(){
	...
	$('ul.gallery li').hover(function(){
        ...
        $trade_id=$(this).parent().attr('id');
        $thubnail_id=$(this).attr('id').split('-');
        $id=$thubnail_id[1];
		$(this).append("<div class='well gallery-controls'>"+
            "<p><a class='gallery-edit btn' href='edit?id="+$id+"'"+"><i class='icon-edit'></i></a><a class='gallery-delete btn' href='/Template/delete?id="+$id+"&trade_id="+$trade_id+            "'"+"><i class='icon-remove'></i></a></p>"+
        "</div>");
